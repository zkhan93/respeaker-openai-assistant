...
Numbered architecture decisions (`AD-n`), each with the alternatives that were
rejected and why. **Amend in place; never delete rationale.** A decision you
disagree with is fine to overturn — but overturn it deliberately, and record
what changed, because most of these were paid for with a bug.

- **What the system looks like today** → [ARCHITECTURE.md](ARCHITECTURE.md)
- **What happens next** → [ROADMAP.md](ROADMAP.md)
- **Facts that cost us something to find** → [LEARNINGS.md](LEARNINGS.md)

**Created:** 2026-08-05 · **Restructured:** 2026-08-09
Extends the architecture review of 2026-07-06 (see the final section).
