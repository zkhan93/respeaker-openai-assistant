...
def simple_record(duration: int = 15):
    ...
    from voice_assistant.commands.simple_record import main as simple_record_main
...
def test_stt_consumer():
    """Test speech-to-text consumer with event-driven architecture."""
    import signal
    from datetime import datetime

    from voice_assistant.config import load_config
    from voice_assistant.consumers.stt_consumer import SpeechToTextConsumer
    from voice_assistant.core.audio_handler import AudioHandler
    from voice_assistant.core.event_bus import EventBus, HotwordEvent
    from voice_assistant.core.hotword_detector import HotwordDetector
